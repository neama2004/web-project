...
function filterProducts(category) {
    const products = document.querySelectorAll(".product");
    const filterButtons = document.querySelectorAll(".sidebar-menu li");

    filterButtons.forEach(button => button.classList.remove("active"));
    document.querySelector(`[onclick="filterProducts('${category}')"]`).parentElement.classList.add("active");
